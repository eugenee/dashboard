module powerbi.visuals.samples {
    ...
    export class AsterPlot implements IVisual {
        ...
        private drawCenterText(innerRadius: number): void {
            let centerTextProperties: TextProperties = AsterPlot.GetCenterTextProperties(innerRadius * AsterPlot.CenterTextFontHeightCoefficient, this.getCenterText(this.dataView));
            this.centerText
                .style({
                    'line-height': 1,
